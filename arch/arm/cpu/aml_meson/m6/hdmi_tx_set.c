...
{
    hdmi_wr_reg(TX_HDMI_PHY_CONFIG5, 0xe7);
    hdmi_wr_reg(TX_HDMI_PHY_CONFIG1, 0xfe);
    hdmi_wr_reg(TX_HDMI_PHY_CONFIG2, 0xff);
    hdmi_wr_reg(TX_HDMI_PHY_CONFIG3, 0xf7);
    switch(vic) {
    case HDMI_480p60:
    case HDMI_480p60_16x9:
    case HDMI_480i60:
    ...
    case HDMI_576i50:
    case HDMI_576i50_16x9:
        hdmi_wr_reg(TX_HDMI_PHY_CONFIG4, 0x2);
        hdmi_wr_reg(TX_HDMI_PHY_CONFIG6, 0x30);
        break;
    case HDMI_720p50:
    case HDMI_720p60:
    case HDMI_1080i50:
    ...
    case HDMI_1080p25:
    case HDMI_1080p30:
        hdmi_wr_reg(TX_HDMI_PHY_CONFIG4, 0x12);
        hdmi_wr_reg(TX_HDMI_PHY_CONFIG6, 0x40);
        break;
    case HDMI_1080p60:
    case HDMI_1080p50:
        hdmi_wr_reg(TX_HDMI_PHY_CONFIG4, 0x22);
        hdmi_wr_reg(TX_HDMI_PHY_CONFIG6, 0x40);
        break;
    default:
        hdmi_wr_reg(TX_HDMI_PHY_CONFIG4, 0x22);
...
{
    if(vic >= HDMI_4k2k_30) {
        printf("hdmitx not support format %d\n", vic);
        return ;
    }
    hdmi_tx_gate(vic);
    hdmi_tx_clk(vic);
